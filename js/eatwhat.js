$(function() {
	...
	l.click(function() {
		if (g.toggleClass("playing", !i), i) i = 0,
		"monster" == w && x.text(u[t(u.length)]),
		c.text("！"),
		l.find("span").text("换一个"),
		clearTimeout(b),
		document.title = a.text() + "这是一个很无聊的网站，但能解决你的人生一大困扰！选择困难户必备！";
		else {
			i = 1,
			k++,
			2 == k && e("我就知道你会换一个 ( ͡° ͜ʖ ͡°)"),
			5 == k && e("说，你是不是天秤座？Σ( ° △ °|||)︴"),
			10 == k && e("你是吃了炫迈吗？(￣△￣；)"),
